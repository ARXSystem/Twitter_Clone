        ...
        <div class="row">
            ...
            <div class="col-xs-8">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li role="presentation" class="active"><a href="follow.php?id=<?=$get_id?>">Followings <span class="badge"><?php print htmlspecialchars($follow_counter, ENT_QUOTES, 'UTF-8'); ?></span></a></li>
                ...
                <ul class="media-list">
                    ...
                    foreach($records as $record){
                        ...
                        <li class="media">
                            <div class="media-left">
                                <?php if($f_image_url==NULL){ ?>
                                <img class="media-object img-rounded" src="../uploads/basic.png" width="120px" height="120px" alt="">
                                <?php }else{ ?>
                                <img class="media-object img-rounded" src="<?php print ($f_image_url); ?>" width="120px" height="120px" alt="">
                                <?php } ?>
                            </div>
